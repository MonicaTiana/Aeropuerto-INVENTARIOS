    ...
    public partial class AgregarMantenimiento : Form
    {
        ...
        public void agregar(string tabla)
        {
            try
            {
                ...
                comando = new SqlCommand("INSERT INTO Mantenimento(NOMBRE,CANTIDAD, PRECIO, AREA, DEPARTAMENTO,MARCA,MODELO,TIPO_INVENTARIO, TIPO, FECHA) VALUES('" + this.txtnombre.Text + "','" + this.txtcantidad.Text + "','" + this.txtprecio.Text + "','" + this.comboBoxarea.Text + "','" + this.comboBoxdepa.Text + "','" + this.txtmarca.Text + "','" + this.txtmodelo.Text + "','" + this.comboBoxtipoinv.Text + "','" + this.comboBoxtipo.Text + "','" + txt_fecha.Text + "')", conexion);
        ...
        private void AgregarMantenimiento_Load(object sender, EventArgs e)
        {
