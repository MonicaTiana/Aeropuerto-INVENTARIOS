...
{
    public partial class Add_Registros_Limpiesa : Form
    {
        ...
        public void agregar(string tabla)
        {
            try
            {
                ...
                comando = new SqlCommand("INSERT INTO Limpiesa(NOMBRE,CANTIDAD, PRECIO, AREA, DEPARTAMENTO,MARCA,MODELO,TIPO_INVENTARIO, TIPO, FECHA) VALUES('" + this.txtnombre.Text + "','" + this.txtcantidad.Text + "','" + this.txtprecio.Text + "','" + this.comboBoxarea.Text + "','" + this.comboBoxdepa.Text + "','" + this.txtmarca.Text + "','" + this.txtmodelo.Text + "','" + this.comboBoxtipoinv.Text + "','" + this.comboBoxtipo.Text + "','" + this.txt_fecha.Text + "')", conexion);
        ...
        private void Add_Registros_Limpiesa_Load(object sender, EventArgs e)
        {
        ...
        {
            Modificar_Registro_Limpieza ir = new Modificar_Registro_Limpieza();
            ir.Show();
            this.Close();
        }
        ...
        {
            Borra_Registro_Limpieza ir = new Borra_Registro_Limpieza();
            ir.Show();
            this.Close();
        }
        ...
        {
            Buscar_Registro_Limpieza ir = new Buscar_Registro_Limpieza();
            ir.Show();
            this.Close();
        }
